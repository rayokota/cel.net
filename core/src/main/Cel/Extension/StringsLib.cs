    ...
    public class StringsLib : Library
    {
        ...
        public virtual IList<EnvOption> CompileOptions
        {
            get
            {
                ...
                EnvOption option = EnvOptions.Declarations(
                    Decls.NewFunction(CHAR_AT,
                        Decls.NewInstanceOverload("string_char_at_int",
                            new List<Google.Api.Expr.V1Alpha1.Type> { Decls.String, Decls.Int }, Decls.String)),
                    Decls.NewFunction(INDEX_OF,
                        Decls.NewInstanceOverload("string_index_of_string",
                            new List<Google.Api.Expr.V1Alpha1.Type> { Decls.String, Decls.String }, Decls.Int),
                        Decls.NewInstanceOverload("string_index_of_string_int",
                            new List<Google.Api.Expr.V1Alpha1.Type> { Decls.String, Decls.String, Decls.Int },
                            Decls.Int)),
                    Decls.NewFunction(JOIN,
                        Decls.NewInstanceOverload("list_join",
                            new List<Google.Api.Expr.V1Alpha1.Type> { Decls.NewListType(Decls.String) }, Decls.String),
                    ...
                    Decls.NewFunction(LOWER_ASCII,
                        Decls.NewInstanceOverload("string_lower_ascii",
                            new List<Google.Api.Expr.V1Alpha1.Type> { Decls.String }, Decls.String)),
                    Decls.NewFunction(REPLACE,
                        Decls.NewInstanceOverload("string_replace_string_string",
                            new List<Google.Api.Expr.V1Alpha1.Type> { Decls.String, Decls.String, Decls.String },
                            Decls.String),
                        Decls.NewInstanceOverload("string_replace_string_string_int",
                            new List<Google.Api.Expr.V1Alpha1.Type>
                    ...
                    Decls.NewFunction(SPLIT,
                        Decls.NewInstanceOverload("string_split_string",
                            new List<Google.Api.Expr.V1Alpha1.Type> { Decls.String, Decls.String }, Decls.Dyn),
                    ...
                    Decls.NewFunction(SUBSTR,
                        ...
                        Decls.NewInstanceOverload("string_substring_int_int",
                            new List<Google.Api.Expr.V1Alpha1.Type> { Decls.String, Decls.Int, Decls.Int },
                            Decls.String)),
        ...
        public virtual IList<ProgramOption> ProgramOptions
        {
            get
            {
                ...
                ProgramOption functions = global::Cel.ProgramOptions.Functions(
                    Overload.Binary(CHAR_AT, Guards.CallInStrIntOutStr(StringsLib.CharAt)),
                    Overload.overload(INDEX_OF, Trait.None, null, Guards.CallInStrStrOutInt(StringsLib.IndexOf),
                        Guards.CallInStrStrIntOutInt(StringsLib.IndexOfOffset)),
                    Overload.overload(JOIN, Trait.None, Guards.CallInStrArrayOutStr(StringsLib.Join),
                        Guards.CallInStrArrayStrOutStr(StringsLib.JoinSepartor), null),
                    ...
                    Overload.Unary(LOWER_ASCII, Guards.CallInStrOutStr(StringsLib.LowerASCII)), Overload.overload(
                    ...
                    Overload.overload(SPLIT, Trait.None, null, Guards.CallInStrStrOutStrArr(StringsLib.Split),
                        Guards.CallInStrStrIntOutStrArr(StringsLib.SplitN)),
                    Overload.overload(SUBSTR, Trait.None, null, Guards.CallInStrIntOutStr(StringsLib.Substr),
