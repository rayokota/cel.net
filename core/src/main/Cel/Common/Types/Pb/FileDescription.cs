...
namespace Cel.Common.Types.Pb
{
	...
	public sealed class FileDescription
	{
	  ...
	  private FileDescription(IDictionary<string, PbTypeDescription> types, IDictionary<string, EnumValueDescription> enums)
	  {
		this.types = types;
		this.enums = enums;
	  }
	  ...
	  internal sealed class FileMetadata
	  {
		...
		internal FileMetadata(IDictionary<string, Descriptor> msgTypes, IDictionary<string, EnumValueDescriptor> enumValues)
		{
		...
		/// </summary>
		internal static void CollectMsgTypes(IList<Descriptor> msgTypes, IDictionary<string, Descriptor> msgTypeMap, IDictionary<string, EnumValueDescriptor> enumValueMap)
		{
		...
		internal static void CollectEnumValues(IList<EnumDescriptor> enumTypes, IDictionary<string, EnumValueDescriptor> enumValueMap)
		{
