...
//JAVA TO C# CONVERTER WARNING: The .NET Type.FullName property will not always yield results identical to the Java Class.getName method:
                throw new System.ArgumentException(String.Format("unsupported field selection target: ({0}){1}",
        ...
        public bool Enum
        {
            get { return desc.FieldType == FieldType.Enum; }
        }
        ...
        public bool Message
        {
            get { return desc.FieldType == FieldType.Message; }
        }
        ...
        public bool Oneof
        {
            get { return desc.ContainingOneof != null; }
        }
        ...
        public bool List
        {
            get { return desc.IsRepeated && !desc.IsMap; }
        }
