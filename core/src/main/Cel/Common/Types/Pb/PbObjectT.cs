...
//	import static Cel.common.types.Types.boolOf;
	...
	public sealed class PbObjectT : ObjectT
	{
	  ...
	  private PbObjectT(TypeAdapter adapter, Message value, PbTypeDescription typeDesc, Type typeValue) : base(adapter, value, typeDesc, typeValue)
	  {
	  }
...
//JAVA TO C# CONVERTER WARNING: The .NET Type.FullName property will not always yield results identical to the Java Class.getName method:
		throw new System.ArgumentException(Err.NewTypeConversionError(value.GetType().FullName, typeDesc).ToString());
	  }
