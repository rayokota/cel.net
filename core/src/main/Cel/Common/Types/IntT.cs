...
//	import static Cel.Common.Types.UintT.uintOf;
	...
	public sealed class IntT : BaseVal, Adder, Comparer, Divider, Modder, Multiplier, Negater, Subtractor
	{
	  ...
	  public static readonly Type IntType = TypeT.NewTypeValue(TypeEnum.Int, Trait.AdderType, Trait.ComparerType, Trait.DividerType, Trait.ModderType, Trait.MultiplierType, Trait.NegatorType, Trait.SubtractorType);
...
//JAVA TO C# CONVERTER WARNING: The .NET Type.FullName property will not always yield results identical to the Java Class.getName method:
		throw new Exception(String.Format("native type conversion error from '{0}' to '{1}'", IntType, typeDesc.FullName));
	  }
