...
//	import static Cel.Common.Types.UintT.uintOf;
	...
	public sealed class DoubleT : BaseVal, Adder, Comparer, Divider, Multiplier, Negater, Subtractor
	{
	  ...
	  public static readonly Type DoubleType = TypeT.NewTypeValue(TypeEnum.Double, Trait.AdderType, Trait.ComparerType, Trait.DividerType, Trait.MultiplierType, Trait.NegatorType, Trait.SubtractorType);
...
//JAVA TO C# CONVERTER WARNING: The .NET Type.FullName property will not always yield results identical to the Java Class.getName method:
		throw new Exception(string.Format("native type conversion error from '{0}' to '{1}'", DoubleType, typeDesc.FullName));
	  }
