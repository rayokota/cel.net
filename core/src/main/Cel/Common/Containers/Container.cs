...
namespace Cel.Common.Containers
{
    ...
    /// 
    /// <para>The program container can be used to simplify variable, function, and type specification
    ...
    public sealed class Container
    {
        ...
        /// 
        /// <para>The name may conceptually be a namespace, package, or type.
        /// </para>
        /// </summary>
        public string Name()
        {
        ...
        /// order.
        /// 
        /// <para>Names which shadow other names are returned first. If a name includes a leading dot ('.'),
        /// the name is treated as an absolute identifier which cannot be shadowed.
        /// 
        /// </para>
        /// <para>Given a container name a.b.c.M.N and a type name R.s, this will deliver in order:
        /// 
        /// </para>
        /// <para>{@code a.b.c.M.N.R.s}<br>
        /// {@code a.b.c.M.R.s}<br>
        /// {@code a.b.c.R.s}<br>
        /// {@code a.b.R.s}<br>
        /// {@code a.R.s}<br>
        ...
        /// 
        /// </para>
        /// <para>If aliases or abbreviations are configured for the container, then alias names will take
        ...
        /// 
        /// <para>If the name is qualified, the first component of the qualified name is checked against known
        /// aliases. Any alias that is found in a qualified name is expanded in the result:
        /// 
        /// </para>
        /// <para>{@code alias: R -> my.alias.R}</br> {@code name: R.S.T}</br> {@code output:
        /// my.alias.R.S.T}</br>
        /// 
        /// </para>
        /// <para>Note, the name must not have a leading dot.
        /// </para>
        /// </summary>
        ...
        public static string ToQualifiedName(Expr e)
        {
            switch (e.ExprKindCase)
            {
                ...
                case Expr.ExprKindOneofCase.SelectExpr:
                    Expr.Types.Select sel = e.SelectExpr;
                    if (sel.TestOnly)
                    {
                        return null;
                    }

                    string qual = ToQualifiedName(sel.Operand);
                    if (!string.ReferenceEquals(qual, null))
                    {
        ...
        /// <summary>
        /// aliasSet returns the alias to fully-qualified name mapping stored in the container. </summary>
        ...
        /// 
        /// <para>Note, ContainerOption implementations must be able to handle nil container inputs.
        /// </para>
        /// </summary>
        ...
        public static ContainerOption Abbrevs(params string[] qualifiedNames)
        {
            return c =>
            {
                foreach (string qn in qualifiedNames)
                {
        ...
        internal static ContainerOption AliasAs(string kind, string qualifiedName, string alias)
        {
            return c =>
            {
                ...
                {
                    throw new System.ArgumentException(String.Format("{0} must refer to a valid qualified name: {1}",
                        kind, qualifiedName));
                }
        ...
        /// <summary>
        /// Name sets the fully-qualified name of the Container. </summary>
