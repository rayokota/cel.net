...
//JAVA TO C# CONVERTER NOTE: Field name conflicts with a method name of the current type:
	  ...
	  internal SourceImpl(string content, string description, IList<int> lineOffsets) : this(content, description, lineOffsets, new Dictionary<long, int>())
	  {
	  }

	  internal SourceImpl(string content, string description, IList<int> lineOffsets, IDictionary<long, int> idOffsets)
	  {
