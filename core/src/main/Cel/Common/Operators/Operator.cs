...
namespace Cel.Common.Operators
{
    ...
    {
        // Symbolic operators.
        public static readonly Operator Conditional =
            new Operator("Conditional", InnerEnum.Conditional, "_?_:_", 8, null);
        ...
        public static readonly Operator GreaterEquals =
            new Operator("GreaterEquals", InnerEnum.GreaterEquals, "_>=_", 5, ">=");
        ...
        public static readonly Operator NotStrictlyFalse =
            new Operator("NotStrictlyFalse", InnerEnum.NotStrictlyFalse, "@not_strictly_false");

        public static readonly Operator In = new Operator("In", InnerEnum.In, "@in", 5, "in");

        // Deprecated: named operators with valid identifiers.
        public static readonly Operator OldNotStrictlyFalse = new Operator("OldNotStrictlyFalse",
