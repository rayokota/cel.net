...
//	import static Cel.common.containers.Container.name;
    ...
    public class EnvOptions
    {
        ...
        /// 
        /// <para>Clearing macros will ensure CEL expressions can only contain linear evaluation paths, as
        ...
        /// 
        /// <para>Note: This option must be specified before the Types and TypeDescs options when used
        /// together.
        /// </para>
        /// </summary>
        ...
        /// 
        /// <para>Note: Declarations will by default be appended to the pre-existing declaration set
        ...
        /// 
        /// <para>Note, it is still possible to have heterogeneous aggregates when provided as variables to
        ...
        /// 
        /// <para>If all references within an expression are relative to a protocol buffer package, then
        ...
        /// 
        /// <para>An abbreviation (abbrev for short) is a simple name that expands to a fully-qualified name.
        ...
        /// 
        /// </para>
        /// <para>Only one the qualified names above may be used as the CEL container, so at least one of
        ...
        /// 
        /// </para>
        /// <para>There are a few rules for the qualified names and the simple abbreviations generated from
        /// them:
        /// 
        /// <ul>
        ...
        /// 
        /// </para>
        /// <para>Abbreviations are distinct from container-based references in the following important ways:
        /// 
        /// <ul>
        ...
        /// 
        /// </para>
        /// <para>If there is ever a case where an identifier could be in both the container and as an
        ...
        /// 
        /// <para>The input types may either be instances of `proto.Message` or `ref.Type`. Any other type
        /// provided to this option will result in an error.
        /// 
        /// </para>
        /// <para>Well-known protobuf types within the `google.protobuf.*` package are included in the
