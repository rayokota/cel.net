...
//	import static Cel.Interpreter.InterpretablePlanner.newUncheckedPlanner;
	...
	public interface Interpreter
	{
	  ...
	  /// </summary>
	  static Interpreter NewInterpreter(Dispatcher dispatcher, Container container, TypeProvider provider, TypeAdapter adapter, AttributeFactory attrFactory)
	  {
	  ...
	  /// </summary>
	  static Interpreter NewStandardInterpreter(Container container, TypeProvider provider, TypeAdapter adapter, AttributeFactory resolver)
	  {
	...
	internal Interpreter_ExprInterpreter(Dispatcher dispatcher, Container container, TypeProvider provider, TypeAdapter adapter, AttributeFactory attrFactory)
	{
	...
	{
	  InterpretablePlanner p = InterpretablePlanner.NewPlanner(dispatcher, provider, adapter, attrFactory, container, @checked, decorators);
	...
	{
	  InterpretablePlanner p = InterpretablePlanner.NewUncheckedPlanner(dispatcher, provider, adapter, attrFactory, container, decorators);
	  return p.Plan(expr);
	}
	  }
