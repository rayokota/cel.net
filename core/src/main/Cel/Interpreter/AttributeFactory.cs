...
//	import static Cel.Interpreter.Coster.costOf;
    ...
    public interface AttributeFactory
    {
        ...
        static AttributeFactory_Qualifier NewQualifierStatic(TypeAdapter adapter, long id, object v)
        {
            ...
            throw new System.InvalidOperationException(String.Format("invalid qualifier type: {0}",
                v.GetType().ToString()));
        }
    ...
    public interface AttributeFactory_ConstantQualifierEquator : QualifierValueEquator,
