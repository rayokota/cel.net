...
public class UintTest
{
    ...
    public virtual void UintAdd()
    {
        ...
        Assert.That(UintT.UintOf(ulong.MaxValue - 1).Add(UintT.UintOf(1)).Equal(UintT.UintOf(ulong.MaxValue)),
    ...
    {
        var lt = UintT.UintOf(204);
        var gt = UintT.UintOf(1300);
    ...
    {
        var val = (Any)UintT.UintOf(ulong.MaxValue).ConvertToNative(typeof(Any));
    ...
    {
        var val = (int)UintT.UintOf(10000).ConvertToNative(typeof(int));
    ...
    public virtual void UintConvertToNativePtrUint64()
    {
        ...
        var val = (ulong)UintT.UintOf(ulong.MaxValue - 3).ConvertToNative(typeof(ulong));
    ...
    {
        var val = (uint)UintT.UintOf(uint.MaxValue).ConvertToNative(typeof(UInt32Value));
        Assert.That(val, Is.EqualTo(uint.MaxValue));

        var val2 = (ulong)UintT.UintOf(ulong.MaxValue).ConvertToNative(typeof(UInt64Value));
    ...
    public virtual void UintConvertToType()
    {
        ...
        Assert.That(UintT.UintOf(4).ConvertToType(DoubleT.DoubleType).Equal(DoubleT.DoubleOf(4)),
            Is.SameAs(BoolT.True));
        Assert.That(UintT.UintOf(4).ConvertToType(StringT.StringType).Equal(StringT.StringOf("4")),
            Is.SameAs(BoolT.True));
    ...
    public virtual void UintMultiply()
    {
        ...
        Assert.That(
            UintT.UintOf(0x7fffffffffffffffL).Multiply(UintT.UintOf(2)).Equal(UintT.UintOf(0xfffffffffffffffeL)),
            Is.SameAs(BoolT.True));
    }
    ...
    public virtual void UintSubtract()
    {
        ...
        Assert.That(UintT.UintOf(0xfffffffffffffffeL).Subtract(UintT.UintOf(0xffffffffffffffffL)),
            Is.SameAs(Err.ErrUintOverflow));
        Assert.That(
            UintT.UintOf(0xffffffffffffffffL).Subtract(UintT.UintOf(0xffffffffffffffffL)).Equal(UintT.UintOf(0)),
            Is.SameAs(BoolT.True));
    }
}