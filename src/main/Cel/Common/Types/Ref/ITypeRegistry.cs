...
/// <summary>
///     ITypeRegistry allows third-parties to add custom types to CEL. Not all `TypeProvider`
...
/// </summary>
public interface ITypeRegistry : ITypeAdapterProvider, ITypeProvider
{
    /// <summary>
    ...
    ///     </para>
    /// </summary>
    void RegisterType(params IType[] types);
}